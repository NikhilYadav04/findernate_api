...
Widget buildContentTypeInfo(
  ...
  switch (contentType) {
    case 'business':
      return _buildBusinessInfo(sw, sh, postData);
    case 'service':
      return _buildServiceInfo(sw, sh, postData);
    case 'product':
...
Widget _buildBusinessInfo(double sw, double sh, Map<String, dynamic> postData) {
...
Widget _buildServiceInfo(double sw, double sh, Map<String, dynamic> postData) {
